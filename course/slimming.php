...
<head>
 ...
 <title>MIRACLE HIR</title>
  <link rel="stylesheet" href="slimming.css">
        ...
        <section>
              <div class="top_content">
                   ...
                   <div class="student_login">
                       <div class="banner">
                         <h1 class="text">MIRACLE SLIM SOLUTIONS</h1>
                         <p class="sub_title">the best <span>solution miracle</span> Slim treatment</p>
                   ...
                   <div class="speceal">
                        <h1 class="text span">MIRACLE SLIMMING SOLUTION</h1>
                    <div class="camb_banner">
                          <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-1.jpg" alt="paavai"></div>
                          <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-2.jpg" alt="miracle"></div>
                          <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-3.jpg" alt="paavai"></div>
                    </div>
                    <!--secont contituon-->
                    <!-- <div class="camb_banner">
                         <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-4.jpg" alt="paavai"></div>
                         <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-5 (1).jpg" alt="paavai"></div>
                         <div class="poly_camb"><img class="img1" src="MIRACLE/slimmg/slim-7 (1).jpg" alt="paavai"></div>
                   </div> -->
               </div>
               <div class="students_manege">
                    <div class="our_content">
                         <h1 class="text span">MIRACLE SLIMMING TREATMENT</h1>
                         <p class="sub_title">The demand for facial aesthetic services has increased significantly. The ability to provide dramatic benefits without surgery has been a perfect match for this segment of the population. The resulting rise in the number of medspa and medical esthetic practices has made these lunchtime procedures more accessible, and has aided in their increasing popularity</p>
                    </div>
                    <div class="student_img_banner">
                          <div class="poly_student">
                              <img class="img1 footer_root" src="MIRACLE/slimmg/slim-6 (1).jpg"  alt="paavai">
                          </div>
                    </div>
               </div>
